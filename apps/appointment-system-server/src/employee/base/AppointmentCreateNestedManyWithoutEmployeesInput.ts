...
@InputType()
class AppointmentCreateNestedManyWithoutEmployeesInput {
...
export { AppointmentCreateNestedManyWithoutEmployeesInput as AppointmentCreateNestedManyWithoutEmployeesInput };
